...
8. **Игнорируемые ошибки записи в WebSocket** — `conn.WriteMessage(...)` без проверки ошибки при AUTH_FAILURE, keepalive, disconnect.
...
- [ ] **Reconnect с учётом сессии** — сервер принимает re-auth по session ID, восстанавливает сессию, клиент восстанавливает TUN и маршруты
...
*Реестр сессий, пер-session маршрутизация, пулы IP, dual-stack AUTH_SUCCESS*
